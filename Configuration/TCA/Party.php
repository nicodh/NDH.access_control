...
$GLOBALS['TCA']['tx_accesscontrol_domain_model_party'] = array(
	'ctrl' => $GLOBALS['TCA']['tx_accesscontrol_domain_model_party']['ctrl'],
	'interface' => array(
	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_accesscontrol_domain_model_party.pid=###CURRENT_PID### AND tx_accesscontrol_domain_model_party.sys_language_uid IN (-1,0)',
			),
		),
